    ...
    return(
        <section id="service" className=" ">
            <div className="w-full h-auto bg-no-repeat bg-ServiceCar bg-center">
                ...
                <div className="md:flex flex-row  md:mt-32 pb-10 md:gap-16 mx-auto">
                <div>
                    ...
                    <p className="text-center font-sans font-custom-700   text-2xl small-3xl">Car sales</p> 
                       <p className="text-center px-4 font-custom-400 md:text-xl lg:text-2xl  font-sa text-custom-black mt-4 max-w-screen-sm mx-auto">
                ...
                <div >
                    ...
                    <p className="text-center px-4 md:text-xl lg:text-2xl font-custom-400  font-sa text-custom-black mt-4 max-w-screen-sm mx-auto">At YourCar, we make it easy to sell your car. Simply bring your vehicle in for an appraisal, and we'll handle the rest.
